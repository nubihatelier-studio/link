...
export const t = {
  ...
  /** La guía de tallas, en el menú de inicio y en el del editor — ver SizeGuideDialog y data/sizeGuide.ts. */
  sizeGuide: {
    menu: 'Guía de tallas',
    menuHint: 'Pulseras, tobilleras, collares y anillos',
    title: 'Guía de tallas',
    lead: 'Todas las medidas en centímetros. Usa la calculadora si tienes la medida de la clienta a mano.',
    close: 'Cerrar',
    sectionsLabel: 'Secciones de la guía',
    nav: {
    ...
    calc: {
      ...
      unitIn: 'pulgadas',
      fit: 'Cómo le gusta',
      fitOption: (cm: string, name: string) => `${name} (+${cm} cm)`,
      finger: 'Contorno del dedo',
      fingerHint: 'Mide con un hilo o tira de papel alrededor de la base del dedo.',
      empty: 'Escribe una medida para ver el resultado.',
      wristOf: (cm: string) => `Muñeca de ${cm} cm`,
      kids: (talla: string) => `Niños: aprox. ${talla}`,
      women: (talla: string) => `Mujer talla ${talla}`,
      men: (talla: string) => `Hombre talla ${talla}`,
      bracelet: (cm: string) => `Pulsera de ${cm} cm`,
      ringSize: (n: number) => `Talla ${n}`,
      ringTooBig: 'Más de talla 13',
      diameter: (cm: string) => `Diámetro interior ${cm} cm`,
      between: 'quedó entre tallas, se sugiere la mayor',
    },
    /** Los tres nombres de la holgura, en el mismo orden que `HOLGURAS`. */
    fits: [
      { name: 'Ajustada', desc: 'Pegada a la piel' },
      { name: 'Cómoda', desc: 'La más vendida' },
      { name: 'Suelta', desc: 'Que se mueva' },
    ],
    size: 'Talla',
    age: 'Edad',
    cm: 'cm',
    bracelets: {
      title: 'Pulseras',
      tag: 'contorno de muñeca',
      women: 'Mujer',
      men: 'Hombre',
      kids: 'Niños',
      easeTitle: 'Largo de la pulsera = muñeca + holgura',
      easeNote: 'En tejidos Miyuki anchos o pulseras gruesas, suma medio centímetro extra porque el grosor le quita espacio interior.',
      inchesTitle: 'Tallas en pulgadas (tiendas extranjeras)',
      bracelet: 'Pulsera',
      forWrist: 'Para muñeca de',
      inchesNote: '1 pulgada = 2,54 cm. En esta tabla la pulsera mide unos 1,3 cm más que la muñeca, la misma holgura "cómoda" de arriba.',
    },
    anklets: {
      title: 'Tobilleras',
      tag: 'contorno del tobillo',
      note: 'Mide justo sobre el hueso del tobillo. La tobillera suele quedar un poco suelta para que caiga sobre el pie.',
    },
    necklaces: {
      title: 'Collares',
      tag: 'largo total',
      ...
      name: 'Nombre',
      falls: 'Dónde cae',
      diagram: 'Dónde cae cada largo de collar',
      note: '42 cm es el largo más pedido para mujer. En hombre se suele usar 50 cm.',
    },
    rings: {
      title: 'Anillos',
      tag: 'numeración americana (US)',
      circumference: 'Contorno',
      diameter: 'Diámetro interior',
      note: 'El diámetro interior es el contorno dividido por π.',
    },
    measure: {
      title: 'Cómo medir',
      wrist: 'Muñeca y tobillo',
      wristSteps: [
        'Usa una huincha de costura o una tira de papel.',
        'Rodea justo sobre el hueso, sin apretar.',
        'Marca donde se junta y mide en una regla.',
        'Suma la holgura según cómo le guste usarla.',
      ],
      finger: 'Dedo',
      fingerSteps: [
        'Envuelve un hilo en la base del dedo.',
        'Verifica que pase por el nudillo.',
        'Mide el hilo y busca el contorno en la tabla.',
        'Si queda entre dos tallas, elige la mayor.',
      ],
      necklace: 'Collar',
      necklaceSteps: [
        'Pon un hilo alrededor del cuello.',
        'Déjalo caer hasta donde quieres el colgante.',
        'Mide el hilo completo: ese es el largo.',
      ],
    },
    footer: 'Medidas de referencia reunidas de tablas comunes del rubro. Cada muñeca es distinta: ante la duda, pide la medida exacta.',
  },
  notFound: {
